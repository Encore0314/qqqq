...
//------------------ 样式定义 ---------------------------//
//  年、月的样式
var s_sss_turn_base = "height:20px;font-size:12px;color:white;border:0 solid #CCCCCC;cursor: pointer;background-color:#2650A6;";
//翻年、月等的按钮
var s_sss_turn = "width:28px;" + s_sss_turn_base;
//关闭、清空等按钮样式
var s_sss_turn2 = "width:22px;" + s_sss_turn_base;
//年选择下拉框
var s_sss_select = "width:64px;display:none;";
//月、时、分选择下拉框
var s_sss_select2 = "width:46px;display:none;";
//日期选择控件体的样式
var s_sss_body = "width:150px;background-color:#2650A6;display:none;z-index:9998;position:absolute;" +
"border-left:1px solid #CCCCCC;border-top:1px solid #CCCCCC;border-right:1px solid #999999;border-bottom:1px solid #999999;";
//显示日（一号到三十号）的样式
var s_sss_day = "width:21px;height:22px;background-color:#D8F0FC;font-size:12px;";
//最上面黄色字体样式
var s_sss_font = "color:#FFCC00;font-size:14px;cursor:pointer;";
//清空、关闭、确定按钮的样式
var s_sss_link = "text-decoration:none;font-size:12px;color:#2650A6;";
//横线
var s_sss_line = "border-bottom:1px solid #2650a6";
//------------------ 变量定义 ---------------------------//
...
document.write('<div id="divsssDate" style="'+s_sss_body+'" >');
document.write('<div align="center" id="divsssDateText" isControled="true" style="padding-top:2px;">');
document.write('<span id="sssYearHead" isControled="true" style="'+s_sss_font+'" '+
    'onclick="spanYearCEvent();">&nbsp;年</span>');
document.write('<select id="selTianYear" style="'+s_sss_select+'" isControled="true" '+
    ' onChange="sssYear=this.value;sssSetDay(sssYear,sssMonth);document.all.sssYearHead.style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=sssYearSt;i <= sssYearEnd;i ++){
document.writeln('<option value="' + i + '">' + i + '年</option>');
}
document.write('</select>');
document.write('<span id="sssMonthHead" isControled="true" style="'+s_sss_font+'" '+
    'onclick="spanMonthCEvent();">&nbsp;&nbsp;月</span>');
document.write('<select id="selTianMonth" style="'+s_sss_select2+'" isControled="true" '+
    'onChange="sssMonth=this.value;sssSetDay(sssYear,sssMonth);document.all.sssMonthHead.style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=1;i <= 12;i ++){
...
document.write('</select>');
//document.write('</div>');
//document.write('<div align="center" id="divsssTimeText" isControled="true">');
document.write('<span id="sssHourHead" isControled="true" style="'+s_sss_font+'display:none;" '+
    'onclick="spanHourCEvent();">&nbsp;时</span>');
document.write('<select id="selTianHour" style="'+s_sss_select2+'display:none;" isControled="true" '+
    ' onChange="sssHour=this.value;sssWriteHead();document.all.sssHourHead.style.display=\'\';' +
    'this.style.display=\'none\';">');
for(var i=0;i <= 23;i ++){
document.writeln('<option value="' + i + '">' + i + '时</option>');
}
document.write('</select>');
document.write('<span id="sssMinuteHead" isControled="true" style="'+s_sss_font+'display:none;" '+
    'onclick="spanMinuteCEvent();">&nbsp;&nbsp;分</span>');
document.write('<select id="selTianMinute" style="'+s_sss_select2+'display:none;" isControled="true" '+
    ' onChange="sssMinute=this.value;sssWriteHead();document.all.sssMinuteHead.style.display=\'\';'+
    'this.style.display=\'none\';">');
for(var i=0;i <= 59;i ++){
...
document.write('</div>');
//输出一条横线
document.write('<div style="'+s_sss_line+'"></div>');
document.write('<div align="center" id="divsssTurn" style="border:0px;" isControled="true">');
document.write('<input type="button" style="'+s_sss_turn+'" value="年↑" title="上一年" onClick="sssPrevYear();">');
document.write('<input type="button" style="'+s_sss_turn+'" value="年↓" title="下一年" onClick="sssNextYear();">&nbsp;');
document.write('<input type="button" style="'+s_sss_turn+'" value="月↑" title="上一月" onClick="sssPrevMonth();">');
document.write('<input type="button" style="'+s_sss_turn+'" value="月↓" title="下一月" onClick="sssNextMonth();">');
document.write('</div>');
//输出一条横线
document.write('<div style="'+s_sss_line+'"></div>');
document.write('<table border=0px cellspacing=0px cellpadding=0px bgcolor=white onselectstart="return false">');
document.write(' <tr style="background-color:#2650A6;font-size:10px;color:white;height:22px;" isControled="true">');
for(var i =0;i < weekName.length;i ++){
//输出星期
document.write('<td width="21px" align="center" isControled="true">' + weekName[i] + '</td>');
}
document.write(' </tr>');
document.write('</table>');
//输出天的选择
document.write('<table border=0px cellspacing=1px cellpadding=0px bgcolor=white onselectstart="return false">');
var n = 0;
for (var i=0;i<5;i++) { 
document.write (' <tr align=center id="trsssDay' + i + '" >');
for (var j=0;j<7;j++){
document.write('<td align="center" id="tdsssDay' + n + '" '+
    'onClick="sssDay=this.innerText;sssSetValue(true);" ' 
   +' style="' + s_sss_day + '">&nbsp;</td>');
n ++;
}
document.write (' </tr>');
}
document.write (' <tr align=center id="trsssDay5" >');
document.write('<td align="center" id="tdsssDay35" onClick="sssDay=this.innerText;sssSetValue(true);" ' 
    +' style="' + s_sss_day + '">&nbsp;</td>');
document.write('<td align="center" id="tdsssDay36" onClick="sssDay=this.innerText;sssSetValue(true);" ' 
    +' style="' + s_sss_day + '">&nbsp;</td>');
document.write('<td align="right" colspan="5"><a href="javascript:sssClear();" style="' + s_sss_link + '">清空</a>'+
    '&nbsp;<a href="javascript:sssHideControl();" style="' + s_sss_link + '">关闭</a>' +
    '&nbsp;<a href="javascript:sssSetValue(true);" style="' + s_sss_link + '">确定</a>&nbsp;' +
    '</td>');
document.write (' </tr>');
document.write('</table>');
document.write('</div>');
...
if(sssYear > 999 && sssYear <10000){sssYear--;}
...
if(sssMonth>1){sssMonth--}else{sssYear--;sssMonth=12;}
sssSetDay(sssYear,sssMonth);
...
if(sssMonth==12){sssYear++;sssMonth=1}else{sssMonth++}
sssSetDay(sssYear,sssMonth);
checkSelect(document.all.selTianMonth,sssMonth);
sssWriteHead();
}
...
sssOutObject.value = value;
//document.all.divsssDate.style.display = "none";
if( bolHideControl ) {
sssHideControl();
}
}
...
var h = dads.offsetHeight;
var w = dads.offsetWidth;
//计算left
...
iY=0;
//alert(iX+'--'+iY);
dads.setStyle('left',iX);
dads.setStyle('top',iY);
sssShowControl();
selectObject();
}
//隐藏日历控件(同时显示被强制隐藏的标签)
...
document.all.divsssDate.style.display = "";
...
x = document.all.divsssDate.offsetLeft;
y = document.all.divsssDate.offsetTop;
h = document.all.divsssDate.offsetHeight;
w = document.all.divsssDate.offsetWidth;
...
if (tagName != "INPUT" && getAttribute("IsControl") != "true" && getAttribute("isControled") !="true")
    sssHideControl();
}
}
//按ESC键关闭该控件
